...
class BackfillDefaultSupportIntroductionOnUsers extends Migration
{
    public function up(): void
    {
        ...
        try {
            ...
            DB::rollBack();
            \Log::error('Error en migración BackfillDefaultSupportIntroductionOnUsers: ' . $e->getMessage());
            throw $e;
        }
    }
    ...
    public function down(): void
    {
        ...
        try {
            ...
            DB::rollBack();
            \Log::error('Error en rollback BackfillDefaultSupportIntroductionOnUsers: ' . $e->getMessage());
            throw $e;
        }
    }
}
